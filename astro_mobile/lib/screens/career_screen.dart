...
class CareerScreen extends StatelessWidget {
  ...
  const CareerScreen({super.key, required this.lang, this.embed = false});
       ...
       return Container(
          decoration: const BoxDecoration(
             gradient: LinearGradient(
               ...
               colors: [Color(0xFF002B36), Color(0xFF073642)]
             )
          ),
          child: _buildBody(),
       );
  ...
  Widget _buildBody() {
    ...
    try {
       // Search for MC or MIDHEAVEN case-insensitive if needed, but usually standardized
